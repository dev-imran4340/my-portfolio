...
abstract final class PortfolioData {
  ...
  static const projects = <Project>[
    ...
    Project(
      slug: 'coinszar',
      name: 'CoinsZar - Crypto Market Portfolio & Community App',
      category: 'Crypto · Flutter',
      summary:
          'Flutter crypto app with real-time market data, portfolio tracking, a multi-level referral network, and peer-to-peer USDT gift packets.',
      technologies: [
        'Flutter',
        'Dart',
        'REST API',
      ...
      features: [
        'Real-time market dashboard with live prices and charts',
        '4-level affiliate / referral network',
        'Deposits, withdrawals and staking records',
        'USDT gift packet create & claim',
        'KYC, 2FA, language and dark mode',
      ],
      accent: Color(0xFF5B8DEF),
      screenshotAsset: 'assets/images/coinszar.png',
      galleryAssets: [
        'assets/images/coinszar.png',
      ],
      caseStudy: ProjectCaseStudy(
        overview:
            'Developed CoinsZar, a comprehensive Flutter-based mobile application tailored for cryptocurrency enthusiasts. The app provides real-time market data directly from leading exchanges, detailed portfolio tracking for personal assets, and robust community engagement tools, including a multi-level referral network and a unique gift packet sharing feature.',
        problem: '',
        solution: '',
        myRole: '',
        myContribution: '',
        keyFeatures: [
          'Real-time Market Dashboard — live crypto prices (BTC, ETH, etc.), interactive candlestick charts, and personal account summaries (Current Balance, Staked Amount)',
          'Affiliate Network Management — 4-level team and referral system with real-time status tracking (Active/Inactive), performance metrics, and rewards distribution',
          'Asset Tracking & Records — secure transaction history for deposits, withdrawals, and staking activities, with status updates (Pending/Failed/Completed)',
          'Gift Packet Feature — peer-to-peer distribution system to create and claim crypto Gift Packets (in USDT) with custom parameters',
          'App Settings & Security — KYC verification, Two-Factor Authentication (2FA), language selection, and Dark Mode',
        ],
        technologies: [
          'Flutter',
          'Dart',
